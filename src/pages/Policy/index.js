  ...
  return (
    <Wrapper>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to COVID-19 Report in Chiang
            Mai.
          </p>
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to COVID-19 Report in Chiang Mai,
          accessible from https://covid-19-cnx.web.app/
        </li>{' '}
        <li>
      ...
      <p>
        ...
        Connect. These services will authenticate your identity and provide you
        the option to share certain personal information with us such as your
        name and email address to pre-populate our sign up form.
      </p>
      ...
      <ul>
        <li>
          By visiting this page on our website: https://covid-19-cnx.web.app/
        </li>
      </ul>
    </Wrapper>
  );
